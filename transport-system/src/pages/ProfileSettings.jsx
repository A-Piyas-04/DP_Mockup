    ...
    return (
        <div style={{ paddingBottom: '80px' }}>
            ...
            <div className="card" style={{ padding: 0, overflow: 'hidden' }}>
                <div style={{ display: 'flex', alignItems: 'center', padding: '16px', borderBottom: '1px solid #f3f4f6', cursor: 'pointer' }}>
            ...
            <div className="card" style={{ padding: 0, overflow: 'hidden' }}>
                <div style={{ display: 'flex', alignItems: 'center', padding: '16px', cursor: 'pointer' }}>
                    ...
                    <div style={{ width: '40px', height: '20px', backgroundColor: '#e5e7eb', borderRadius: '10px', position: 'relative' }}>
